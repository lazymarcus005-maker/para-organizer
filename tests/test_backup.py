...
def test_settings_get_defaults(client, test_db):
    ...
    assert set(body.keys()) == {
        ...
        "NOTIFY_STALE_DAYS", "NOTIFY_CHANNEL", "AUTO_ARCHIVE_DAYS",
        "RECLASSIFY_INTERVAL_HOURS", "RECLASSIFY_CONFIDENCE_THRESHOLD",
        "LLM_PRIMARY", "LLM_FALLBACK", "LLM_TIMEOUT", "LLM_MAX_RETRIES",
        "CHAT_MODEL", "CHAT_HISTORY_MAX", "CHAT_SYSTEM_PROMPT",
        "EMBED_PROVIDER", "EMBED_BASE_URL", "EMBED_MODEL",
        "RAG_HYBRID_ENABLED", "RAG_HYBRID_RATIO", "RAG_SEARCH_LIMIT",
    }
